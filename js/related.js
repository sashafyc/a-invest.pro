(function(){
  var articles = [
    ...
    {slug:'poisk-pokupatelya.html', tag:'Продажа бизнеса', title:'Поиск покупателя для бизнеса: где и как искать', desc:'4 канала поиска покупателя, как составить объявление и квалифицировать покупателей.'},
    {slug:'prodazha-ooo.html', tag:'Продажа бизнеса', title:'Как продать ООО: пошаговая инструкция', desc:'Два формата продажи ООО, пошаговый процесс оформления доли, налоги и типичные ошибки.'},
    {slug:'prodazha-doli.html', tag:'Продажа бизнеса', title:'Продажа доли в бизнесе: как оформить сделку', desc:'Оценка доли с дисконтом миноритария, преимущественное право, нотариальное оформление и налоги.'},
    {slug:'prodazha-kompanii.html', tag:'Продажа бизнеса', title:'Как продать компанию: этапы и документы', desc:'Этапы продажи компании: подготовка, NDA, поиск покупателя, due diligence, закрытие сделки.'},
    {slug:'kak-prodat-kompaniyu.html', tag:'Продажа бизнеса', title:'Как продать компанию быстро и выгодно', desc:'Как ускорить продажу и не потерять в цене: подготовка, каналы поиска, переговоры и типичные ошибки.'},
    {slug:'kak-prodat-biznes-investoru.html', tag:'Продажа бизнеса', title:'Как продать бизнес инвестору: стратегия и подготовка', desc:'Типы инвесторов, инвест-предложение, оценка через мультипликаторы, структуры сделок. Кейсы из практики.'}
  ];
