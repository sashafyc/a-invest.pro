...
1. Прочитать `_materials/content-guide.md` — контент-план, статусы дистрибуции, площадки
...
- [ ] **Апрель 2026** — опубликовать `kak-prodat-biznes` на VC (тема: Деньги)
- [ ] Заменить все TG-ссылки на `https://t.me/+8dqlu_D7E4UyMzJi`
